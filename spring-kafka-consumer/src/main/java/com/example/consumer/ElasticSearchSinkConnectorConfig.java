...
public class ElasticSearchSinkConnectorConfig extends AbstractConfig {
    ...
    private static final String EX_CLUSTER_HOST_DEFAULT_VALUE = "localhost";
    ...
    public static ConfigDef CONFIG = new ConfigDef()
            .define(ES_CLUSTER_HOST, ConfigDef.Type.STRING, EX_CLUSTER_HOST_DEFAULT_VALUE, ConfigDef.Importance.HIGH, ES_CLUSTER_HOST_DOC)
